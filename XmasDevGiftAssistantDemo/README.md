...
## Visual Studio
- Open XmasDevGiftAssistantDemo.csproj in Visual Studio.
...
- File -> Open bot and open [XmasDevGiftAssistantDemo.bot](XmasDevGiftAssistantDemo.bot).
